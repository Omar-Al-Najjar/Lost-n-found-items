...
export function ProfileScreen({
  ...
  const heroTitleColor = isDark ? palette.textPrimary : palette.card;
  const heroSubtitleColor = isDark ? palette.textSecondary : palette.accentStrong;
  const heroEyebrowColor = palette.accent;
  const shortcutMutedSurface = isDark ? palette.surfaceAlt : palette.cardMuted;
  const reportsPillBackground = isDark ? palette.surfaceAlt : palette.textPrimary;
  const reportsPillText = isDark ? palette.textPrimary : palette.accentStrong;
  ...
  return (
    <>
      ...
      <ScrollView contentContainerStyle={styles.contentContainer} showsVerticalScrollIndicator={false}>
        ...
        >
          <Text style={[styles.heroEyebrow, { color: heroEyebrowColor }, isArabic && styles.textRight]}>{t.profile}</Text>
          <Text style={[styles.heroTitle, { color: heroTitleColor }, isArabic && styles.textRight]}>{t.fullName}</Text>
          <Text style={[styles.heroSubtitle, { color: heroSubtitleColor }, isArabic && styles.textRight]}>
            {copy.shortcutsTitle}
          </Text>
        </Animated.View>
        ...
        <Animated.View style={{ width: '92%', opacity: sectionOpacity, transform: [{ translateY: sectionY }] }}>
          ...
          <View style={[styles.settingCard, { backgroundColor: palette.card, borderColor: palette.border }]}>
            <View style={[styles.settingRow, isArabic && styles.rowReverse]}>
              ...
              <View style={[styles.langSwitchWrap, { backgroundColor: shortcutMutedSurface }]}>
        ...
        >
          ...
          <Pressable
            style={({ pressed }) => [
              styles.shortcutCard,
              { backgroundColor: palette.card, borderColor: palette.border, opacity: pressed ? 0.92 : 1 },
            ]}
            onPress={onOpenNotifications}
          >
            <View style={[styles.shortcutTopRow, isArabic && styles.rowReverse]}>
              <View style={[styles.shortcutIconWrap, { backgroundColor: shortcutMutedSurface }]}>
            ...
            <View style={[styles.shortcutFooter, isArabic && styles.rowReverse]}>
              ...
              <Text style={[styles.shortcutLink, { color: palette.accent }]}>{copy.openShortcut}</Text>
            </View>
          </Pressable>
          ...
          >
            <View style={[styles.shortcutTopRow, isArabic && styles.rowReverse]}>
              ...
              <View style={[styles.shortcutCountPill, { backgroundColor: reportsPillBackground }]}>
                <Text style={[styles.shortcutCountText, { color: reportsPillText }]}>
        ...
        <Animated.View style={{ width: '92%', opacity: logoutOpacity, transform: [{ translateY: logoutY }] }}>
          ...
          >
            ...
            <Text style={[styles.logoutText, { color: palette.danger }]}>{t.logout}</Text>
          </Pressable>
        </Animated.View>
